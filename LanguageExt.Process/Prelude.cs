...
namespace LanguageExt
{
    ...
    public static partial class Process
    {
        ...
        ///             ))
        /// </param>
        public static Unit configure(string path, IEnumerable<FuncSpec> additionalStrategyFunctions)
        {
        ...
        ///             ))
        /// </param>
        public static Unit configure(IEnumerable<FuncSpec> additionalStrategyFunctions) =>
            configure(additionalStrategyFunctions);
