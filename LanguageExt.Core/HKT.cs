...
{
    public static partial class HKTInternal
    {
        internal static T ValueT<T>(this IEnumerable<T> self) => self.FirstOrDefault();
        internal static T ValueT<T>(this Option<T> self) => self.IsSome ? self.Value : default(T);
        internal static T ValueT<T>(this OptionUnsafe<T> self) => self.IsSome ? self.Value : default(T);
        internal static T ValueT<T>(this Lst<T> self) => self.FirstOrDefault();
        internal static T ValueT<K, T>(this Map<K, T> self) => self.Values.FirstOrDefault();
        internal static T ValueT<T>(this TryOption<T> self) => self.Try().Value.IfNone(default(T));
        internal static T ValueT<T>(this Try<T> self) => self.Try().Value;
        internal static T ValueT<L, T>(this Either<L, T> self) => self.IsRight ? self.RightValue : default(T);
        internal static T ValueT<L, T>(this EitherUnsafe<L, T> self) => self.IsRight ? self.RightValue : default(T);
        internal static T ValueT<Out, T>(this Writer<Out, T> self) => self().Value;
        ...
        public static T Lift<T>(this IEnumerable<T> self) => self.ValueT();
        public static T Lift<T>(this Option<T> self) => self.ValueT();
        public static T Lift<T>(this OptionUnsafe<T> self) => self.ValueT();
        public static T Lift<T>(this Lst<T> self) => self.ValueT();
        public static T Lift<K, T>(this Map<K, T> self) => self.ValueT();
        public static T Lift<T>(this TryOption<T> self) => self.ValueT();
        public static T Lift<T>(this Try<T> self) => self.ValueT();
        public static T Lift<L, T>(this Either<L, T> self) => self.ValueT();
        public static T Lift<L, T>(this EitherUnsafe<L, T> self) => self.ValueT();
        public static T Lift<Out, T>(this Writer<Out, T> self) => self.ValueT();
    ...
    public static partial class HKT
    {
        ...
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T, K>(this IEnumerable<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T>(this IEnumerable<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T, L>(this IEnumerable<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T, L>(this IEnumerable<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static IEnumerable<T> ValueT<T, Out>(this IEnumerable<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T, K>(this Option<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T>(this Option<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T, L>(this Option<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T, L>(this Option<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Option<T> ValueT<T, Out>(this Option<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T, K>(this OptionUnsafe<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T>(this OptionUnsafe<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T, L>(this OptionUnsafe<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T, L>(this OptionUnsafe<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static OptionUnsafe<T> ValueT<T, Out>(this OptionUnsafe<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T, K>(this Lst<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T>(this Lst<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T, L>(this Lst<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T, L>(this Lst<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Lst<T> ValueT<T, Out>(this Lst<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T>(this Map<K, Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T, L>(this Map<K, Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T, L>(this Map<K, EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Map<K, T> ValueT<K, T, Out>(this Map<K, Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T, K>(this TryOption<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T>(this TryOption<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T, L>(this TryOption<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T, L>(this TryOption<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static TryOption<T> ValueT<T, Out>(this TryOption<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T, K>(this Try<Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T>(this Try<Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T, L>(this Try<Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T, L>(this Try<EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Try<T> ValueT<T, Out>(this Try<Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T, K>(this Either<L, Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T>(this Either<L, EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Either<L, T> ValueT<L, T, Out>(this Either<L, Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, Option<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T, K>(this EitherUnsafe<L, Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, Try<T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T>(this EitherUnsafe<L, EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static EitherUnsafe<L, T> ValueT<L, T, Out>(this EitherUnsafe<L, Writer<Out, T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, IEnumerable<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, Option<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, OptionUnsafe<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, Lst<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T, K>(this Writer<Out, Map<K, T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, TryOption<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, Try<T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T, L>(this Writer<Out, Either<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T, L>(this Writer<Out, EitherUnsafe<L, T>> self) => self.MapT(x => x.ValueT());
        internal static Writer<Out, T> ValueT<Out, T>(this Writer<Out, Writer<Out, T>> self) => self.MapT(x => x.ValueT());
