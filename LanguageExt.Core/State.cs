...
{
    /// <summary>
    /// For computations which read and write to a shared state.
    /// 
    /// Monad values are functions from the state to a (value, state). The bound function 
    /// is applied to the bound value, and both have access to the shared state.
    /// 
    ...
    /// <param name="state">Shared state value</param>
    /// <returns>A value that represents the bound value and the resulting shared
    /// state value.</returns>
