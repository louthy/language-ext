...
public static partial class Prelude
{
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static EitherAsync<L, R> plus<NUM, L, R>(EitherAsync<L, R> x, EitherAsync<L, R> y) where NUM : Arithmetic<R> =>
        from a in x
        from b in y
        select NUM.Plus(a, b);
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static EitherAsync<L, R> subtract<NUM, L, R>(EitherAsync<L, R> x, EitherAsync<L, R> y) where NUM : Arithmetic<R> =>
        from a in x
        from b in y
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static EitherAsync<L, R> product<NUM, L, R>(EitherAsync<L, R> x, EitherAsync<L, R> y) where NUM : Arithmetic<R> =>
        from a in x
        from b in y
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static EitherAsync<L, R> divide<NUM, L, R>(EitherAsync<L, R> x, EitherAsync<L, R> y) where NUM : Num<R> =>
        from a in x
        from b in y
    ...
    public static EitherAsync<L, B> apply<L, A, B>(EitherAsync<L, Func<A, B>> fab, EitherAsync<L, A> fa) =>
        ApplEitherAsync<L, A, B>.Apply(fab, fa);
    ...
    public static EitherAsync<L, C> apply<L, A, B, C>(EitherAsync<L, Func<A, B, C>> fabc, EitherAsync<L, A> fa, EitherAsync<L, B> fb) =>
        from x in fabc
        from y in ApplEitherAsync<L, A, B, C>.Apply(curry(x), fa, fb)
        select y;
    ...
    public static EitherAsync<L, C> apply<L, A, B, C>(Func<A, B, C> fabc, EitherAsync<L, A> fa, EitherAsync<L, B> fb) =>
        ApplEitherAsync<L, A, B, C>.Apply(curry(fabc), fa, fb);
    ...
    public static EitherAsync<L, Func<B, C>> apply<L, A, B, C>(EitherAsync<L, Func<A, B, C>> fabc, EitherAsync<L, A> fa) =>
        from x in fabc
        from y in ApplEitherAsync<L, A, B, C>.Apply(curry(x), fa)
        select y;
    ...
    public static EitherAsync<L, Func<B, C>> apply<L, A, B, C>(Func<A, B, C> fabc, EitherAsync<L, A> fa) =>
        ApplEitherAsync<L, A, B, C>.Apply(curry(fabc), fa);
    ...
    public static EitherAsync<L, Func<B, C>> apply<L, A, B, C>(EitherAsync<L, Func<A, Func<B, C>>> fabc, EitherAsync<L, A> fa) =>
        ApplEitherAsync<L, A, B, C>.Apply(fabc, fa);
    ...
    public static EitherAsync<L, B> action<L, A, B>(EitherAsync<L, A> fa, EitherAsync<L, B> fb) =>
        ApplEitherAsync<L, A, B>.Action(fa, fb);
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static IAsyncEnumerable<L> lefts<L, R>(IEnumerable<EitherAsync<L, R>> self) =>
        self.Lefts();
    ...
    [Pure]
    [Obsolete(Change.UseEffMonadInstead)]
    public static IAsyncEnumerable<R> rights<L, R>(IEnumerable<EitherAsync<L, R>> self) =>
        self.Rights();
