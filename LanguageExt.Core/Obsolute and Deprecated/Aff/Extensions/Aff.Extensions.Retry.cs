...
public static partial class AffExtensions
{
    ...
    public static Aff<RT, A> Retry<RT, A>(this Aff<RT, A> ma) where RT : HasIO<RT, Error> =>
    ...
    /// <typeparam name="A">Computation bound value type</typeparam>
    /// <returns>The result of the last invocation of ma</returns>
    public static Aff<RT, A> Retry<RT, A>(this Aff<RT, A> ma, Schedule schedule) where RT : HasIO<RT, Error> =>
    ...
    /// <typeparam name="A">Computation bound value type</typeparam>
    /// <returns>The result of the last invocation of ma</returns>
    public static Aff<RT, A> RetryWhile<RT, A>(this Aff<RT, A> ma, Func<Error, bool> predicate) where RT : HasIO<RT, Error> =>
    ...
    /// <typeparam name="A">Computation bound value type</typeparam>
    /// <returns>The result of the last invocation of ma</returns>
    public static Aff<RT, A> RetryWhile<RT, A>(this Aff<RT, A> ma, Schedule schedule, Func<Error, bool> predicate) where RT : HasIO<RT, Error> =>
    ...
    /// <typeparam name="A">Computation bound value type</typeparam>
    /// <returns>The result of the last invocation of ma</returns>
    public static Aff<RT, A> RetryUntil<RT, A>(this Aff<RT, A> ma, Func<Error, bool> predicate) where RT : HasIO<RT, Error> =>
    ...
    /// <typeparam name="A">Computation bound value type</typeparam>
    /// <returns>The result of the last invocation of ma</returns>
    public static Aff<RT, A> RetryUntil<RT, A>(this Aff<RT, A> ma, Schedule schedule, Func<Error, bool> predicate) where RT : HasIO<RT, Error> =>
