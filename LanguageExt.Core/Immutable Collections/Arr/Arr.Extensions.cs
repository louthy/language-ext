...
public static class ArrExtensions
{
    ...
    /// </summary>
    [Pure]
    public static S Aggregate<T, S>(this Arr<T> source, S seed, Func<S, T, S> func) =>
        source.Value.Aggregate(seed, func);

    /// <summary>
    /// Applies an accumulator function over a sequence. The specified seed value is used as the initial accumulator value, and the specified function is used to select the result value.
    /// </summary>
    [Pure]
    public static TRes Aggregate<T, S, TRes>(this Arr<T> source, S seed, Func<S, T, S> func, Func<S, TRes> resultSelector) =>
        source.Value.Aggregate(seed, func, resultSelector);

    /// <summary>
    /// Applies an accumulator function over a sequence.
    /// </summary>
    [Pure]
    public static T Aggregate<T>(this Arr<T> source, Func<T, T, T> func) =>
        source.Value.Aggregate(func);

    /// <summary>
    /// Determines whether all elements of a sequence satisfy a condition.
    /// </summary>
    [Pure]
    public static bool All<T>(this Arr<T> source, Func<T, bool> predicate) =>
        source.Value.All(predicate);

    /// <summary>
    /// Determines whether a sequence contains any elements.
    /// </summary>
    [Pure]
    public static bool Any<T>(this Arr<T> source) =>
        source.Value.Any();
    ...
    /// </summary>
    [Pure]
    public static bool Any<T>(this Arr<T> source, Func<T, bool> predicate) =>
        source.Value.Any(predicate);

    /// <summary>
    /// Returns the input typed as IEnumerable<T>.
    /// </summary>
    [Pure]
    public static IEnumerable<T> AsEnumerable<T>(this Arr<T> source) =>
        source.Value.AsEnumerable();
    ...
    public static IQueryable<TElement> AsQueryable<TElement>(this Arr<TElement> source) =>
        source.Value.AsQueryable().AsQueryable();
    ...
    /// </summary>
    [Pure]
    public static decimal Average<T>(this Arr<T> source, Func<T, decimal> selector) =>
        source.Value.Average(selector);
    ...
    /// </summary>
    [Pure]
    public static double Average<T>(this Arr<T> source, Func<T, double> selector) =>
        source.Value.Average(selector);
    ...
    /// </summary>
    [Pure]
    public static double Average<T>(this Arr<T> source, Func<T, int> selector) =>
        source.Value.Average(selector);
    ...
    /// </summary>
    [Pure]
    public static double Average<T>(this Arr<T> source, Func<T, long> selector) =>
        source.Value.Average(selector);
    ...
    /// </summary>
    [Pure]
    public static float Average<T>(this Arr<T> source, Func<T, float> selector) =>
        source.Value.Average(selector);
    ...
    /// </summary>
    [Pure]
    public static IEnumerable<T> Concat<T>(this Arr<T> first, IEnumerable<T> second) =>
        first.Value.Concat(second);

    /// <summary>
    /// Determines whether a sequence contains a specified element by using the default equality comparer.
    /// </summary>
    [Pure]
    public static bool Contains<T>(this Arr<T> source, T value) =>
        source.Value.Contains(value);

    /// <summary>
    /// Determines whether a sequence contains a specified element by using a specified IEqualityComparer<T>.
    /// </summary>
    [Pure]
    public static bool Contains<T>(this Arr<T> source, T value, IEqualityComparer<T> comparer) =>
        source.Value.Contains(value, comparer);

    /// <summary>
    /// Returns the number of elements in a sequence.
    /// </summary>
    [Pure]
    public static int Count<T>(this Arr<T> source) =>
        source.Value.Count();
    ...
    /// </summary>
    [Pure]
    public static int Count<T>(this Arr<T> source, Func<T, bool> predicate) =>
        source.Value.Count(predicate);

    /// <summary>
    /// Returns the elements of the specified sequence or the type parameter's default value in a singleton collection if the sequence is empty.
    /// </summary>
    [Pure]
    public static IEnumerable<T?> DefaultIfEmpty<T>(this Arr<T> source) =>
        source.Value.DefaultIfEmpty();

    /// <summary>
    /// Returns the elements of the specified sequence or the specified value in a singleton collection if the sequence is empty.
    /// </summary>
    [Pure]
    public static IEnumerable<T> DefaultIfEmpty<T>(this Arr<T> source, T defaultValue) =>
        source.Value.DefaultIfEmpty(defaultValue);

    /// <summary>
    /// Returns distinct elements from a sequence by using the default equality comparer to compare values.
    /// </summary>
    [Pure]
    public static IEnumerable<T> Distinct<T>(this Arr<T> source) =>
        source.Value.Distinct();

    /// <summary>
    /// Returns distinct elements from a sequence by using a specified IEqualityComparer<T> to compare values.
    /// </summary>
    [Pure]
    public static IEnumerable<T> Distinct<T>(this Arr<T> source, IEqualityComparer<T> comparer) =>
        source.Value.Distinct(comparer);
