...
public static partial class Prelude
{
    ...
    /// <param name="f">Mapping function</param>
    /// <returns>Mapped functor</returns>
    public static Arr<B> map<A, B>(Func<A, B> f, Arr<A> ma) =>
        ma.Map(f);    
    
    /// <summary>
    /// Applicative action: runs the first applicative, ignores the result, and returns the second applicative
    /// </summary>
    public static Arr<B> action<A, B>(Arr<A> ma, Arr<B> mb) =>
    ...
    public static Arr<B> apply<A, B>(Arr<Func<A, B>> mf, K<Arr, A> ma) =>
        mf.Kind().Apply(ma).As();
    ...
    /// <param name="mf">Mapping function(s)</param>
    /// <returns>Mapped applicative functor</returns>
    public static Arr<B> apply<A, B>(Arr<Func<A, B>> mf, Arr<A> ma) =>
        mf.Kind().Apply(ma).As();
