...
public static partial class Prelude
{
    ...
    public static Lst<PredList, T> toList<PredList, T>(IEnumerable<T> items) where PredList : Pred<ListInfo> =>
        items as Lst<PredList, T> ?? new Lst<PredList, T>(items);

    /// <summary>
    /// Create an immutable list
    /// </summary>
    [Pure]
    public static Lst<PredList, T> toList<PredList, T>(ReadOnlySpan<T> items) where PredList : Pred<ListInfo> =>
        new (items);
    ...
    public static Lst<PredList, PredItem, T> toList<PredList, PredItem, T>(IEnumerable<T> items) 
        where PredItem : Pred<T>
        where PredList : Pred<ListInfo>  =>
        items as Lst<PredList, PredItem, T> ?? new Lst<PredList, PredItem, T>(items);

    /// <summary>
    /// Create an immutable list
    /// </summary>
    [Pure]
    public static Lst<PredList, PredItem, T> toList<PredList, PredItem, T>(ReadOnlySpan<T> items) 
        where PredItem : Pred<T>
        where PredList : Pred<ListInfo>  =>
        new (items);
