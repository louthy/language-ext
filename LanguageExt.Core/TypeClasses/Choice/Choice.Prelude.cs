...
namespace LanguageExt
{
    public static partial class Choice
    {
        ...
        /// <returns>Returns an either value</returns>
        [Pure]
        public static CH mapBottom<CHOICE, MONAD, CH, A, B>(CH ma, Func<A> bottom)
            where CHOICE : struct, Choice<CH, A, B>
            where MONAD : struct, Monad<CH, B> =>
            default(CHOICE).Match(ma,
                Left: Left<A, B>,
                Right: Right<A, B>,
                Bottom: bottom.Compose(Left<A, B>));
        ...
        ///// <returns>Returns an either value</returns>
        //[Pure]
        //public static Either<A, B> mapBottom<CHOICE, CH, A, B>(CH ma, Func<A> bottom)
        //    where CHOICE : struct, Choice<CH, A, B> =>
        //    default(CHOICE).Match(ma,
        //        Left: Left<A, B>,
        //        Right: Right<A, B>,
