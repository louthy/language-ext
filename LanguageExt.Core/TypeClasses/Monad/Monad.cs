...
namespace LanguageExt.TypeClasses
{
    ...
    public interface Monad<Env, Out, MA, A> : Foldable<Env, MA, A>
    {
        ...
        /// <summary>
        /// The Id function allows the Bind function to asynchronously construct a monad from a function 
        /// that returns a Task<AM> rather than MA.  It's a form of double-dispatch like the BindReturn 
        ...
        ///             select c);
        /// 
        /// The LINQ expression is using the Task Select and SelectMany overloads.  So the result is 
        /// asynchronous.
        /// 
