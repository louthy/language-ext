...
namespace LanguageExt
{
    public static partial class TypeClassExtensions
    {
        ...
        /// <returns>Sequence of As that represent the value(s) in the structure</returns>
        [Pure]
        public static IEnumerable<B> ToSeqT<A, B>(this Foldable<A> self) where A : Foldable<B> =>
            TypeClass.toSeqT<A, B>(self);
        ...
        /// <typeparam name="A">Bound value type</typeparam>
        /// <param name="self">Foldable to perform the operation on</param>
        public static Unit IterT<A, B>(this Foldable<A> self, Action<B> action) where A : Foldable<B> =>
            TypeClass.iterT(self, action);
        ...
        /// <returns>Sequence of As that represent the value(s) in the structure</returns>
        [Pure]
        public static IEnumerable<C> CollectT<A, B, C>(this Foldable<A> self, Func<B, C> f) where A : Foldable<B> =>
            TypeClass.collectT(self, f);
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static S FoldT<A, B, S>(this Foldable<A> fa, S state, Func<S, B, S> f) where A : Foldable<B> =>
            TypeClass.foldT<A, B, S>(fa, state, f);
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static S FoldBackT<A, B, S>(this Foldable<A> fa, S state, Func<S, B, S> f) where A : Foldable<B> =>
            TypeClass.foldBackT<A, B, S>(fa, state, f);
        ...
        /// <returns>First A produced by the foldable</returns>
        [Pure]
        public static B HeadT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.headT<A, B>(fa);
        ...
        /// <returns>First A produced by the foldable (Or None if no items produced)</returns>
        [Pure]
        public static Option<B> HeadOrNoneT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.headOrNoneT<A, B>(fa);
        ...
        /// <returns>Last A produced by the foldable</returns>
        [Pure]
        public static B LastT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.lastT<A, B>(fa);
        ...
        /// <returns>Last A produced by the foldable (Or None if no items produced)</returns>
        [Pure]
        public static Option<B> LastOrNoneT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.lastOrNoneT<A, B>(fa);
        ...
        /// <returns>True if empty, False otherwise</returns>
        [Pure]
        public static bool IsEmptyT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.isEmptyT<A, B>(fa);
        ...
        /// <returns>True if empty, False otherwise</returns>
        [Pure]
        public static int CountT<A, B>(this Foldable<A> fa) where A : Foldable<B> =>
            TypeClass.countT<A, B>(fa);
        ...
        /// <returns>True if item in the structure</returns>
        [Pure]
        public static bool ElemT<EQ, A, B>(this Foldable<A> fa, B item)
            where EQ : struct, Eq<B>
            where A  : Foldable<B> =>
            TypeClass.elemT<EQ, A, B>(fa, item);
        ...
        /// <returns>Sum of the numbers in the structure</returns>
        [Pure]
        public static B SumT<NUM, A, B>(this Foldable<A> fa) 
            where NUM : struct, Num<B>
            where A   : Foldable<B> =>
            TypeClass.sumT<NUM, A, B>(fa);
        ...
        /// <returns>Product of the numbers in the structure</returns>
        [Pure]
        public static B ProductT<NUM, A, B>(this Foldable<A> fa)
            where NUM : struct, Num<B>
            where A   : Foldable<B> =>
            TypeClass.productT<NUM, A, B>(fa);
        ...
        /// <returns>True if the predicate holds for all values</returns>
        [Pure]
        public static bool ForAllT<A, B>(this Foldable<A> fa, Func<B, bool> pred) where A : Foldable<B> =>
            TypeClass.forallT(fa, pred);
        ...
        [Pure]
        public static bool ExistsT<A, B>(this Foldable<A> fa, Func<B, bool> pred) where A : Foldable<B> =>
            TypeClass.existsT(fa, pred);
    }
}
