...
namespace LanguageExt
{
    public static partial class TypeClassExtensions
    {
        ...
        [Pure]
        public static S BiFold<FOLD, F, A, B, S>(this F foldable, S state, Func<S, A, S> fa, Func<S, B, S> fb)
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static S BiFoldBack<FOLD, F, A, B, S>(this F foldable, S state, Func<S, A, S> fa, Func<S, B, S> fb)
            where FOLD : struct, BiFoldable<F, A, B> =>
        ...
        public static Unit BiIter<FOLD, F, A, B>(this F foldable, Action<A> fa, Action<B> fb)
            where FOLD : struct, BiFoldable<F, A, B> =>
        ...
        [Pure]
        public static IEnumerable<Either<A, B>> ToBiSeq<FOLD, F, A, B>(this F foldable)
            where FOLD : struct, BiFoldable<F, A, B> =>
        ...
        [Pure]
        public static IEnumerable<C> BiCollect<FOLD, F, A, B, C>(this F foldable, Func<A, C> fa, Func<B, C> fb)
            where FOLD : struct, BiFoldable<F, A, B> =>
        ...
        [Pure]
        public static bool Contains<EQ, FOLD, F, A, B>(this F foldable, A item)
            where FOLD : struct, BiFoldable<F, A, B>
        ...
        /// <returns>True if item in the structure</returns>
        [Pure]
        public static bool Contains<EQ, FOLD, F, A, B>(this F foldable, B item)
            where FOLD : struct, BiFoldable<F, A, B>
        ...
        [Pure]
        public static bool BiForAll<FOLD, F, A, B>(this F foldable, Func<A, bool> preda, Func<B, bool> predb)
            where FOLD : struct, BiFoldable<F, A, B>
        {
        ...
        /// <returns>True if the predicate holds for all values</returns>
        [Pure]
        public static bool BiExists<FOLD, F, A, B>(this F foldable, Func<A, bool> preda, Func<B, bool> predb)
            where FOLD : struct, BiFoldable<F, A, B>
        {
            foreach (var item in toBiSeq<FOLD, F, A, B>(foldable))
            {
