...
namespace LanguageExt
{
    public static partial class TypeClassExtensions
    {
        ...
        /// <returns>The result of the operation</returns>
        [Pure]
        public static HashMap<K, V> Append<K, V>(this HashMap<K, V> x, HashMap<K, V> y) =>
        ...
        /// <returns>The result of the operation</returns>
        [Pure]
        public static HashSet<A> Append<A>(this HashSet<A> x, HashSet<A> y) =>
        ...
        /// <returns>The result of the operation</returns>
        [Pure]
        public static IEnumerable<A> Append<SEMI, A>(this IEnumerable<A> x, IEnumerable<A> y) where SEMI : struct, Semigroup<A>
        {
            foreach (var a in x)
                foreach (var b in y)
