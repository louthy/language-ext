...
public interface KArrow2<F, Env, X, G, A> 
    ...
    //where G : KLift<G>
{
    ...
    /// </summary>
    Transducer<Env, Sum<X, KStar<G, A>>> Morphism { get; }

    public KArrow2<F, Env, X, G, A> AsKind() => this;
}
...
/// <typeparam name="Env">Lower kind input type</typeparam>
/// <typeparam name="A">Lower kind output type</typeparam>
public interface KArrow2<F, Env, X, A> 
    //where F : KLift2<F, Env, X>
{
    /// <summary>
    /// Transducer from `A` to `B`
    /// </summary>
    Transducer<Env, Sum<X, A>> Morphism { get; }
    
    public KArrow2<F, Env, X, A> AsKind() => this;
}
