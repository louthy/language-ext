...
public static class IEnumerableEitherTransExt
{
    ...
    [Pure]
    public static IEnumerable<Either<LRet, RRet>> BiBindT<L, R, LRet, RRet>(this IEnumerable<Either<L, R>> self, Func<R, Either<LRet, RRet>> Right, Func<L, Either<LRet, RRet>> Left) =>
        self.Map(x => x.BiBind(Right, Left));

    [Pure]
    public static IEnumerable<Either<L, R>> BiFilterT<L, R>(this IEnumerable<Either<L, R>> self, Func<R, bool> Right, Func<L, bool> Left) =>
...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        [Pure]
        public static IEnumerable<Either<LRet, RRet>> bibindT<L, R, LRet, RRet>(IEnumerable<Either<L, R>> self, Func<R, Either<LRet, RRet>> Right, Func<L, Either<LRet, RRet>> Left) =>
            self.Map(x => x.BiBind(Right, Left));

        [Pure]
        public static IEnumerable<Either<L, R>> bifilterT<L, R>(IEnumerable<Either<L, R>> self, Func<R, bool> Right, Func<L, bool> Left) =>
            self.Map(x => x.BiFilter(Right, Left));
    }
}
