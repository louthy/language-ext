...
public static class ArrayWriterRefExtensions
{
    extension<A>(ref ArrayWriterRef<A> writer)
    {
        /// <summary>
        ...
        public void Add(A value) =>
            ArrayWriterRef<A>.Add(ref writer, value);
        ...
        public void AddRange(ReadOnlySpan<A> values) =>
            ArrayWriterRef<A>.AddRange(ref writer, values);
        ...
        public (A[] Buffer, long Start, long Count) ToArray()
        {
            ...
            {
                throw new ObjectDisposedException(nameof(ArrayWriterRef<>));
            }
        }
