...
public static partial class OptionAsyncExtensions
{
    ...
    [Pure]
    public static OptionAsync<A> AddAsync<NUM, A>(this Option<A> x, Option<A> y) where NUM : Num<A> =>
    ...
    [Pure]
    public static OptionAsync<A> SubtractAsync<NUM, A>(this Option<A> x, Option<A> y) where NUM : Num<A> =>
    ...
    [Pure]
    public static OptionAsync<A> ProductAsync<NUM, A>(this Option<A> x, Option<A> y) where NUM : Num<A> =>
    ...
    [Pure]
    public static OptionAsync<A> DivideAsync<NUM, A>(this Option<A> x, Option<A> y) where NUM : Num<A> =>
