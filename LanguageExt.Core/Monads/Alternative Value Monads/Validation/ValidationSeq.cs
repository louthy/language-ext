...
namespace LanguageExt
{
        ...
        ISerializable
    {
        ...
        /// <returns>Mapped Validation</returns>
        [Pure]
        public Validation<FAIL, Ret> BiMap<Ret>(Func<SUCCESS, Ret> Success, Func<Seq<FAIL>, Seq<FAIL>> Fail) =>
        ...
        /// <returns>Mapped Validation</returns>
        [Pure]
        public Validation<FAIL, SUCCESS> MapFail<Ret>(Func<Seq<FAIL>, Seq<FAIL>> Fail) =>
            FValidation<FAIL, SUCCESS, SUCCESS>.Inst.BiMap(this, Fail, identity);
