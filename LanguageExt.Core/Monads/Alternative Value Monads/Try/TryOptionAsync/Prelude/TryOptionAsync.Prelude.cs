...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        public static TryOptionAsync<A> TryOptionAsync<A>(Func<Task<A>> f) =>
            TryOptionAsyncExtensions.Memo(async () => new OptionalResult<A>(await f().ConfigureAwait(false)));
        ...
        public static TryOptionAsync<A> TryOptionAsync<A>(Task<A> v) =>
            TryOptionAsyncExtensions.Memo(async () => new OptionalResult<A>(await v.ConfigureAwait(false)));
