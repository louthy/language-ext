...
namespace LanguageExt
{
    public static partial class OptionAsyncExtensions
    {
        ...
        /// <returns>The result of the match operation</returns>
        [Pure]
        public static Task<R> MatchUntypedAsync<A, R>(this Option<A> self, Func<object, Task<R>> Some,
            Func<Task<R>> None) =>
            matchUntypedAsync<MOptionAsync<A>, OptionAsync<A>, A, R>(self.ToAsync(), Some, None);
        ...
        [Pure]
        public static Task<Seq<A>> ToSeqAsync<A>(this Option<A> self) =>
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static Task<S> BiFoldAsync<S, A>(this Option<A> self, S state, Func<S, A, S> Some,
            Func<S, Unit, S> None) =>
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static Task<S> BiFoldAsync<S, A>(this Option<A> self, S state, Func<S, A, Task<S>> Some,
            Func<S, Unit, S> None) =>
            MOptionAsync<A>.Inst.BiFoldAsync(self.ToAsync(), state, Some, None);
        ...
        public static OptionAsync<Func<B, C>>
            ApplyAsync<A, B, C>(this Option<Func<A, Func<B, C>>> fabc, Option<A> fa) =>
