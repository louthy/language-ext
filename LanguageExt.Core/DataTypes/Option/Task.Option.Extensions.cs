...
namespace LanguageExt
{
    public static class TaskOptionAsyncExtensions
    {
        ...
        /// <returns>The result of the match operation</returns>
        [Pure]
        public static Task<R> MatchUntypedAsync<A, R>(this Task<Option<A>> self, Func<object, Task<R>> Some,
            Func<R> None) =>
            matchUntypedAsync<MOptionAsync<A>, OptionAsync<A>, A, R>(self.ToAsync(), Some, None);
        ...
        /// <returns>The result of the match operation</returns>
        [Pure]
        public static Task<R> MatchUntypedAsync<A, R>(this Task<Option<A>> self, Func<object, R> Some,
            Func<Task<R>> None) =>
            matchUntypedAsync<MOptionAsync<A>, OptionAsync<A>, A, R>(self.ToAsync(), Some, None);
        ...
        [Pure]
        public static Task<EitherUnsafe<L, A>>
            ToEitherUnsafeAsync<L, A>(this Task<Option<A>> self, L defaultLeftValue) =>
        ...
        /// <returns>B, or null</returns>
        [Pure]
        public static Task<B> MatchUnsafeAsync<A, B>(this Task<Option<A>> self, Func<A, Task<B>> Some,
            Func<Task<B>> None) =>
            MOptionAsync<A>.Inst.MatchUnsafeAsync(self.ToAsync(), Some, None);
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static Task<S> BiFoldAsync<S, A>(this Task<Option<A>> self, S state, Func<S, A, S> Some,
            Func<S, Unit, S> None) =>
        ...
        /// <returns>The aggregate state</returns>
        [Pure]
        public static Task<S> BiFoldAsync<S, A>(this Task<Option<A>> self, S state, Func<S, A, Task<S>> Some,
            Func<S, Unit, S> None) =>
            MOptionAsync<A>.Inst.BiFoldAsync(self.ToAsync(), state, Some, None);
        ...
        public static Task<bool>
            BiForAllAsync<A>(this Task<Option<A>> self, Func<A, bool> Some, Func<Unit, bool> None) =>
        ...
        [Pure]
        public static Task<bool>
            BiExistsAsync<A>(this Task<Option<A>> self, Func<A, bool> Some, Func<Unit, bool> None) =>
        ...
        [Pure]
        public static OptionAsync<A> AddAsync<NUM, A>(this Task<Option<A>> x, Task<Option<A>> y)
        ...
        [Pure]
        public static OptionAsync<A> SubtractAsync<NUM, A>(this Task<Option<A>> x, Task<Option<A>> y)
            where NUM : struct, Num<A> =>
        ...
        [Pure]
        public static OptionAsync<A> ProductAsync<NUM, A>(this Task<Option<A>> x, Task<Option<A>> y)
            where NUM : struct, Num<A> =>
        ...
        [Pure]
        public static OptionAsync<A> DivideAsync<NUM, A>(this Task<Option<A>> x, Task<Option<A>> y)
            where NUM : struct, Num<A> =>
        ...
        [Pure]
        public static OptionAsync<C> ApplyAsync<A, B, C>(this Option<Func<A, B, C>> fabc, Task<Option<A>> fa,
            Option<B> fb) =>
        ...
        [Pure]
        public static OptionAsync<Func<B, C>>
            ApplyAsync<A, B, C>(this Option<Func<A, B, C>> fabc, Task<Option<A>> fa) =>
            from x in fabc.ToAsync()
        ...
        /// <returns>Applicative of type f(b -> c) derived from Applicative of Func<B, C></returns>
        [Pure]
        public static OptionAsync<Func<B, C>> ApplyAsync<A, B, C>(this Option<Func<A, Func<B, C>>> fabc,
            Task<Option<A>> fa) =>
