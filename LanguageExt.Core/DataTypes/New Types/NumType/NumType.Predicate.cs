    ...
    where SELF : NumType<SELF, NUM, A, PRED>
{
    ...
    public virtual bool Equals(SELF? other) =>
        !ReferenceEquals(other, null) && NUM.Equals(Value, other.Value);
    ...
    public static SELF operator -(NumType<SELF, NUM, A, PRED> x) =>
        New(NUM.Subtract(NUM.FromInteger(0), ValueOrDefault(x)));
    ...
    [Pure]
    public static SELF operator -(NumType<SELF, NUM, A, PRED> lhs, NumType<SELF, NUM, A, PRED> rhs) =>
        New(NUM.Subtract(ValueOrDefault(lhs), ValueOrDefault(rhs)));
    ...
    [Pure]
    public static SELF operator /(NumType<SELF, NUM, A, PRED> lhs, NumType<SELF, NUM, A, PRED> rhs) =>
        New(NUM.Divide(ValueOrDefault(lhs), ValueOrDefault(rhs)));

    [Pure]
    public static bool operator ==(NumType<SELF, NUM, A, PRED> lhs, NumType<SELF, NUM, A, PRED> rhs) =>
        NUM.Equals(ValueOrDefault(lhs), ValueOrDefault(rhs));
    ...
    [Pure]
    public static bool operator >(NumType<SELF, NUM, A, PRED> lhs, NumType<SELF, NUM, A, PRED> rhs) =>
        NUM.Compare(ValueOrDefault(lhs), ValueOrDefault(rhs)) > 0;
