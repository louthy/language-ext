    ...
    where ORD     : Ord<A>
{
    ...
    public virtual int CompareTo(NEWTYPE? other) =>
        other is null
            ? 1
            : OrdNewType<NEWTYPE, ORD, A, PRED>.Compare(this, other);

    [Pure]
    public virtual bool Equals(NEWTYPE? other) =>
        other is not null && OrdNewType<NEWTYPE, ORD, A, PRED>.Equals(this, other);
    ...
    public override int GetHashCode() =>
        OrdNewType<NEWTYPE, ORD, A, PRED>.GetHashCode(this);
    ...
    public static bool operator ==(NewType<NEWTYPE, A, PRED, ORD> lhs, NewType<NEWTYPE, A, PRED, ORD> rhs) =>
        OrdNewType<NEWTYPE, ORD, A, PRED>.Equals(lhs, rhs);
    ...
    [Pure]
    public static bool operator >(NewType<NEWTYPE, A, PRED, ORD> lhs, NewType<NEWTYPE, A, PRED, ORD> rhs) =>
        OrdNewType<NEWTYPE, ORD, A, PRED>.Compare(lhs, rhs) > 0;
