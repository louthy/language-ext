...
namespace LanguageExt
{
    ...
    public static class OptionUnsafeExtensions
    {
        ...
        [Pure]
        public static OptionUnsafe<A> Add<NUM, A>(this OptionUnsafe<A> x, OptionUnsafe<A> y)
        ...
        [Pure]
        public static OptionUnsafe<A> Subtract<NUM, A>(this OptionUnsafe<A> x, OptionUnsafe<A> y)
            where NUM : struct, Num<A> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static OptionUnsafe<A> Product<NUM, A>(this OptionUnsafe<A> x, OptionUnsafe<A> y)
            where NUM : struct, Num<A> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static OptionUnsafe<A> Divide<NUM, A>(this OptionUnsafe<A> x, OptionUnsafe<A> y)
            where NUM : struct, Num<A> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static OptionUnsafe<C> Apply<A, B, C>(this OptionUnsafe<Func<A, B, C>> fabc, OptionUnsafe<A> fa,
            OptionUnsafe<B> fb) =>
            from x in fabc
        ...
        [Pure]
        public static OptionUnsafe<Func<B, C>>
        ...
        /// <returns>Applicative of type f(b -> c) derived from Applicative of Func<B, C></returns>
        [Pure]
        public static OptionUnsafe<Func<B, C>> Apply<A, B, C>(this OptionUnsafe<Func<A, Func<B, C>>> fabc,
            OptionUnsafe<A> fa) =>
        ...
        [Pure]
        public static IObservable<B> MatchObservable<A, B>(this OptionUnsafe<A> ma, Func<A, IObservable<B>> Some,
            Func<B> None) =>
            ma.IsSome
                ? Some(ma.Value)
        ...
        /// <param name="map">Projection function</param>
        /// <returns>Mapped functor</returns>
        public static async Task<OptionUnsafe<B>>
        ...
        /// </summary>
        public static async Task<OptionUnsafe<B>> BindAsync<A, B>(this OptionUnsafe<A> self,
        ...
        /// Monad bind operation
        /// </summary>
        public static async Task<OptionUnsafe<B>> BindAsync<A, B>(this Task<OptionUnsafe<A>> self,
            Func<A, Task<OptionUnsafe<B>>> bind)
        {
            var val = await self;
            return val.IsSome
        ...
        /// Monad bind operation
        /// </summary>
        public static async Task<OptionUnsafe<B>> BindAsync<A, B>(this OptionUnsafe<Task<A>> self,
            Func<A, OptionUnsafe<B>> bind) =>
            self.IsSome
