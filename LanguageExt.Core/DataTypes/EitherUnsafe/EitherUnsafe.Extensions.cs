...
namespace LanguageExt
{
    ...
    public static class EitherUnsafeExtensions
    {
        ...
        [Pure]
        public static EitherUnsafe<L, R> Plus<NUM, L, R>(this EitherUnsafe<L, R> x, EitherUnsafe<L, R> y)
        ...
        [Pure]
        public static EitherUnsafe<L, R> Subtract<NUM, L, R>(this EitherUnsafe<L, R> x, EitherUnsafe<L, R> y)
            where NUM : struct, Num<R> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static EitherUnsafe<L, R> Product<NUM, L, R>(this EitherUnsafe<L, R> x, EitherUnsafe<L, R> y)
            where NUM : struct, Num<R> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static EitherUnsafe<L, R> Divide<NUM, L, R>(this EitherUnsafe<L, R> x, EitherUnsafe<L, R> y)
            where NUM : struct, Num<R> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static EitherUnsafe<L, C> Apply<L, A, B, C>(this EitherUnsafe<L, Func<A, B, C>> fabc,
            EitherUnsafe<L, A> fa, EitherUnsafe<L, B> fb) =>
            from x in fabc
        ...
        /// <returns>Applicative of type FC derived from Applicative of C</returns>
        [Pure]
        public static EitherUnsafe<L, C> Apply<L, A, B, C>(this Func<A, B, C> fabc, EitherUnsafe<L, A> fa,
            EitherUnsafe<L, B> fb) =>
        ...
        [Pure]
        public static EitherUnsafe<L, Func<B, C>> Apply<L, A, B, C>(this EitherUnsafe<L, Func<A, B, C>> fabc,
            EitherUnsafe<L, A> fa) =>
            from x in fabc
        ...
        /// <returns>Applicative of type f(b -> c) derived from Applicative of Func<B, C></returns>
        [Pure]
        public static EitherUnsafe<L, Func<B, C>> Apply<L, A, B, C>(this EitherUnsafe<L, Func<A, Func<B, C>>> fabc,
            EitherUnsafe<L, A> fa) =>
        ...
        [Pure]
        public static EitherUnsafe<L, Func<T2, R>> ParMap<L, T1, T2, R>(this EitherUnsafe<L, T1> self,
            Func<T1, T2, R> func) =>
            self.Map(curry(func));
        ...
        /// <remarks>TODO: Better documentation of this function</remarks>
        [Pure]
        public static EitherUnsafe<L, Func<T2, Func<T3, R>>> ParMap<L, T1, T2, T3, R>(this EitherUnsafe<L, T1> self,
        ...
        /// </summary>
        public static async Task<R2> MatchAsync<L, R, R2>(this EitherUnsafe<L, Task<R>> self, Func<R, R2> Right,
            Func<L, R2> Left) =>
        ...
        /// </summary>
        [Pure]
        public static IObservable<R2> MatchObservable<L, R, R2>(this EitherUnsafe<L, IObservable<R>> self,
            Func<R, R2> Right, Func<L, R2> Left) =>
            self.IsRight
        ...
        /// </summary>
        [Pure]
        public static IObservable<R2> MatchObservable<L, R, R2>(this IObservable<EitherUnsafe<L, R>> self,
            Func<R, R2> Right, Func<L, R2> Left) =>
            self.Select(either => matchUnsafe(either, Right, Left));

        public static async Task<EitherUnsafe<L, R2>> MapAsync<L, R, R2>(this EitherUnsafe<L, R> self,
            Func<R, Task<R2>> map) =>
            self.IsRight
                ? await map(self.RightValue)
                : LeftUnsafe<L, R2>(self.LeftValue);

        public static async Task<EitherUnsafe<L, R2>> MapAsync<L, R, R2>(this Task<EitherUnsafe<L, R>> self,
            Func<R, Task<R2>> map)
        {
            var val = await self;
            return val.IsRight
        ...
        public static async Task<EitherUnsafe<L, R2>> MapAsync<L, R, R2>(this EitherUnsafe<L, Task<R>> self,
            Func<R, R2> map) =>
            self.IsRight
        ...
        public static async Task<EitherUnsafe<L, R2>> BindAsync<L, R, R2>(this EitherUnsafe<L, R> self,
            Func<R, Task<EitherUnsafe<L, R2>>> bind) =>
            self.IsRight
                ? await bind(self.RightValue)
                : LeftUnsafe<L, R2>(self.LeftValue);

        public static async Task<EitherUnsafe<L, R2>> BindAsync<L, R, R2>(this Task<EitherUnsafe<L, R>> self,
            Func<R, Task<EitherUnsafe<L, R2>>> bind)
        {
            var val = await self;
            return val.IsRight
        ...
        public static async Task<EitherUnsafe<L, R2>> BindAsync<L, R, R2>(this EitherUnsafe<L, Task<R>> self,
            Func<R, EitherUnsafe<L, R2>> bind) =>
            self.IsRight
        ...
        public static async Task<S> FoldAsync<L, R, S>(this Task<EitherUnsafe<L, R>> self, S state,
            Func<S, R, S> folder) =>
            (await self).Fold(state, folder);

        public static async Task<S> FoldAsync<L, R, S>(this EitherUnsafe<L, Task<R>> self, S state,
            Func<S, R, S> folder) =>
            self.IsRight
