...
namespace LanguageExt
{
    public static class ListExtensions
    {
        ...
        [Pure]
        public static IEnumerable<C> Apply<A, B, C>(this IEnumerable<Func<A, B, C>> fabc, IEnumerable<A> fa,
            IEnumerable<B> fb) =>
        ...
        /// IEnumerable of functions: an IEnumerable of functions of arity 1</returns>
        [Pure]
        public static IEnumerable<Func<B, C>> Apply<A, B, C>(this IEnumerable<Func<A, Func<B, C>>> fabc,
            IEnumerable<A> fa) =>
        ...
        /// <returns>Returns the result of applying the IEnumerables of arguments to the IEnumerable of functions</returns>
        [Pure]
        public static IEnumerable<C> Apply<A, B, C>(this IEnumerable<Func<A, Func<B, C>>> fabc, IEnumerable<A> fa,
            IEnumerable<B> fb) =>
        ...
        /// <remarks>TODO: Better documentation of this function</remarks>
        [Pure]
        public static IEnumerable<Func<T2, Func<T3, R>>> ParMap<T1, T2, T3, R>(this IEnumerable<T1> list,
        ...
        /// <returns>Aggregate value</returns>
        [Pure]
        public static S FoldWhile<S, T>(this IEnumerable<T> list, S state, Func<S, T, S> folder,
        ...
        /// <returns>Aggregate value</returns>
        [Pure]
        public static S FoldBackWhile<S, T>(this IEnumerable<T> list, S state, Func<S, T, S> folder,
            Func<T, bool> preditem) =>
        ...
        /// <returns>Aggregate value</returns>
        [Pure]
        public static S FoldUntil<S, T>(this IEnumerable<T> list, S state, Func<S, T, S> folder,
            Func<T, bool> preditem) =>
        ...
        /// <returns>Aggregate value</returns>
        [Pure]
        public static S FoldBackUntil<S, T>(this IEnumerable<T> list, S state, Func<S, T, S> folder,
            Func<T, bool> preditem) =>
        ...
        /// <returns>Lst of T</returns>
        [Pure]
        public static Lst<PredList, T> Freeze<PredList, T>(this IEnumerable<T> list)
            where PredList : struct, Pred<ListInfo> =>
        ...
        /// </summary>
        [Pure]
        public static IEnumerable<B> BindEnumerable<PredList, A, B>(this Lst<PredList, A> self,
            Func<A, Lst<PredList, B>> binder)
            where PredList : struct, Pred<ListInfo>
        {
            foreach (var t in self)
            {
        ...
        /// </summary>
        [Pure]
        public static IEnumerable<B> BindEnumerable<PredList, PredItemA, PredItemB, A, B>(
            this Lst<PredList, PredItemA, A> self, Func<A, Lst<PredList, PredItemB, B>> binder)
            where PredList : struct, Pred<ListInfo>
        ...
        /// </summary>
        [Pure]
        public static Lst<PredList, B> Bind<PredList, A, B>(this Lst<PredList, A> self,
            Func<A, Lst<PredList, B>> binder)
            where PredList : struct, Pred<ListInfo> =>
        ...
        /// </summary>
        [Pure]
        public static Lst<PredList, PredItemB, B> Bind<PredList, PredItemA, PredItemB, A, B>(
            this Lst<PredList, PredItemA, A> self, Func<A, Lst<PredList, PredItemB, B>> binder)
            where PredList : struct, Pred<ListInfo>
            where PredItemA : struct, Pred<A>
            where PredItemB : struct, Pred<B> =>
