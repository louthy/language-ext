...
namespace LanguageExt
{
    public static class TaskTryExtensions
    {
        ...
        /// <returns>The result of either the Succ or Fail delegates</returns>
        [Pure]
        public static Task<R> Match<A, R>(this Task<Try<A>> self, Func<A, Task<R>> Succ,
            Func<Exception, Task<R>> Fail) =>
            self.ToAsync().Match(Succ, Fail);
        ...
        [Pure]
        public static IObservable<R> MatchObservable<A, R>(this Task<Try<A>> self, Func<A, IObservable<R>> Succ,
            Func<Exception, R> Fail) =>
        ...
        [Pure]
        public static IObservable<R> MatchObservable<A, R>(this Task<Try<A>> self, Func<A, IObservable<R>> Succ,
            Func<Exception, IObservable<R>> Fail) =>
            self.ToAsync().MatchObservable(Succ, Fail);
        ...
        /// <returns>An observable that represents the result of Succ or Fail</returns>
        [Pure]
        public static IObservable<R> MatchObservable<A, R>(this Task<Try<A>> self, Func<A, R> Succ,
            Func<Exception, IObservable<R>> Fail) =>
            self.ToAsync().MatchObservable(Succ, Fail);
        ...
        /// <returns>Folded state</returns>
        [Pure]
        public static Task<S> BiFold<A, S>(this Task<Try<A>> self, S state, Func<S, A, S> Succ,
            Func<S, Exception, S> Fail) =>
        ...
        /// <returns>Folded state</returns>
        [Pure]
        public static Task<S> BiFold<A, S>(this Task<Try<A>> self, S state, Func<S, A, Task<S>> Succ,
            Func<S, Exception, S> Fail) =>
            self.ToAsync().BiFold(state, Succ, Fail);
        ...
        public static Task<Try<R>> Map<A, R>(this Task<Try<A>> self, Func<A, R> mapper) =>
            // This method was ambiguous in TryT_Extensions.Select TaskTryExtensions.Select
            TaskTryExtensions.Select(self, mapper);
        ...
        /// <returns>Mapped Try computation</returns>
        [Pure]
        public static Task<Try<R>>
            BiMap<A, R>(this Task<Try<A>> self, Func<A, Task<R>> Succ, Func<Exception, R> Fail) =>
            from x in self.ToAsync().BiMap(Succ, Fail).Try()
            select new Try<R>(() => x);
        ...
        [Pure]
        public static Task<Try<R>>
            BiMap<A, R>(this Task<Try<A>> self, Func<A, R> Succ, Func<Exception, Task<R>> Fail) =>
            from x in self.ToAsync().BiMap(Succ, Fail).Try()
            select new Try<R>(() => x);
        ...
        /// <returns>Mapped Try computation</returns>
        [Pure]
        public static Task<Try<R>> BiMap<A, R>(this Task<Try<A>> self, Func<A, Task<R>> Succ,
            Func<Exception, Task<R>> Fail) =>
            from x in self.ToAsync().BiMap(Succ, Fail).Try()
            select new Try<R>(() => x);
        ...
        [Pure]
        public static Task<Try<A>>
            BiFilter<A>(this Task<Try<A>> self, Func<A, bool> Succ, Func<Exception, bool> Fail) =>
            from x in self.ToAsync().BiFilter(Succ, Fail).Try()
            select new Try<A>(() => x);

        [Pure]
        public static Task<Try<A>> BiFilter<A>(this Task<Try<A>> self, Func<A, Task<bool>> Succ,
            Func<Exception, bool> Fail) =>
            from x in self.ToAsync().BiFilter(Succ, Fail).Try()
            select new Try<A>(() => x);

        [Pure]
        public static Task<Try<A>> BiFilter<A>(this Task<Try<A>> self, Func<A, bool> Succ,
            Func<Exception, Task<bool>> Fail) =>
            from x in self.ToAsync().BiFilter(Succ, Fail).Try()
            select new Try<A>(() => x);
        ...
        /// <returns>lhs + rhs</returns>
        [Pure]
        public static TryAsync<A> Subtract<NUM, A>(this Task<Try<A>> lhs, Task<Try<A>> rhs)
