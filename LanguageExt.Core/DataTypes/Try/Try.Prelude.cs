...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        [Pure]
        public static Try<B> apply<A, B>(Try<Func<A, B>> x, Try<A> y) =>
        ...
        [Pure]
        public static Try<C> apply<A, B, C>(Try<Func<A, B, C>> x, Try<A> y, Try<B> z) =>
        ...
        /// <returns>Returns the result of applying the Try argument to the Try function</returns>
        [Pure]
        public static Try<Func<B, C>> apply<A, B, C>(Try<Func<A, B, C>> x, Try<A> y) =>
        ...
        /// <returns>Returns the result of applying the Try argument to the Try function</returns>
        [Pure]
        public static Try<Func<B, C>> apply<A, B, C>(Try<Func<A, Func<B, C>>> x, Try<A> y) =>
