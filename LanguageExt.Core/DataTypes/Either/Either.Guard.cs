...
namespace LanguageExt
{
    public static class EitherGuardExtensions
    {
        ...
        public static Either<L, B> SelectMany<L, A, B>(this Guard<L> ma, Func<Unit, Either<L, B>> f) =>
            ma.Flag
                ? f(default)
                : Left(ma.OnFalse());

        public static Either<L, C> SelectMany<L, A, B, C>(this Guard<L> ma, Func<Unit, Either<L, B>> bind, Func<Unit, B, C> project) =>
            ma.Flag
