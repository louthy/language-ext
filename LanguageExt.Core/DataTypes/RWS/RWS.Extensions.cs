...
namespace LanguageExt
{
    ...
    public static class RWSExtensions
    {
        ...
        /// </summary>
        public static (TryOption<A> Value, W Output, S State) Run<MonoidW, R, W, S, A>(
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, Seq<A>> AsEnumerable<MonoidW, R, W, S, A>(
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, bool> Exists<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, bool> pred)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
            var (a, w, s, faulted) = self(env, state);
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, bool> ForAll<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, bool> pred)
            where MonoidW : struct, Monoid<W> => Exists(self, pred);

        [Pure]
        public static RWS<MonoidW, R, W, S, B> Fold<MonoidW, R, W, S, A, B>(this RWS<MonoidW, R, W, S, A> self,
            B initialValue, Func<B, A, B> f)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
            var (a, w, s, faulted) = self(env, state);
            return faulted
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, R> Fold<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<R, A, R> f)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
            var (a, w, s, faulted) = self(env, state);
        ...
        /// </summary>
        [Pure]
        public static RWS<MonoidW, R, W, S, Unit> Modify<MonoidW, R, W, S, A>(RWS<MonoidW, R, W, S, A> self,
            Func<S, S> f)
            where MonoidW : struct, Monoid<W> => (env, state) =>
            (unit, default(MonoidW).Empty(), f(state), false);

        [Pure]
        public static RWS<MonoidW, R, W, S, B> Map<MonoidW, R, W, S, A, B>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, B> project)
        ...
        /// </summary>
        [Pure]
        public static RWS<MonoidW, R, W, S, A> Pass<MonoidW, R, W, S, A>(
            this RWS<MonoidW, R, W, S, (A, Func<W, W>)> self)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
        ...
        /// </summary>
        [Pure]
        public static RWS<MonoidW, R, W, S, (A, B)> Listen<MonoidW, R, W, S, A, B>(this RWS<MonoidW, R, W, S, A> self,
            Func<W, B> f)
            where MonoidW : struct, Monoid<W> =>
        ...
        /// </summary>
        [Pure]
        public static RWS<MonoidW, R, W, S, A> Censor<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<W, W> f)
            where MonoidW : struct, Monoid<W> =>
            Pass(
                default(MRWS<MonoidW, R, W, S, A>)
                    .Bind<MRWS<MonoidW, R, W, S, (A, Func<W, W>)>, RWS<MonoidW, R, W, S, (A, Func<W, W>)>, (A,
                        Func<W, W>)>(
                        self, a =>
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, B> Bind<MonoidW, R, W, S, A, B>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, RWS<MonoidW, R, W, S, B>> f)
            where MonoidW : struct, Monoid<W> =>
            default(MRWS<MonoidW, R, W, S, A>).Bind<MRWS<MonoidW, R, W, S, B>, RWS<MonoidW, R, W, S, B>, B>(self, f);

        [Pure]
        public static RWS<MonoidW, R, W, S, B> Select<MonoidW, R, W, S, A, B>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, B> f)
            where MonoidW : struct, Monoid<W> =>
        ...
        public static RWS<MonoidW, R, W, S, C> SelectMany<MonoidW, R, W, S, A, B, C>(
            ...
            default(MRWS<MonoidW, R, W, S, A>).Bind<MRWS<MonoidW, R, W, S, C>, RWS<MonoidW, R, W, S, C>, C>(self, a =>
                default(MRWS<MonoidW, R, W, S, B>).Bind<MRWS<MonoidW, R, W, S, C>, RWS<MonoidW, R, W, S, C>, C>(bind(a),
                    b =>
                        default(MRWS<MonoidW, R, W, S, C>).Return(_ => project(a, b))));

        [Pure]
        public static RWS<MonoidW, R, W, S, A> Filter<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, bool> pred)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
            var (a, w, s, faulted) = self(env, state);
        ...
        [Pure]
        public static RWS<MonoidW, R, W, S, A> Where<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Func<A, bool> pred)
            where MonoidW : struct, Monoid<W> => Filter(self, pred);

        public static RWS<MonoidW, R, W, S, Unit> Iter<MonoidW, R, W, S, A>(this RWS<MonoidW, R, W, S, A> self,
            Action<A> action)
            where MonoidW : struct, Monoid<W> => (env, state) =>
        {
            var (a, w, s, faulted) = self(env, state);
