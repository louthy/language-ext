...
namespace LanguageExt
{
    ...
    /// </remarks>
    public sealed class AtomValue<M, A> where A : struct
    {
        Box value;
        ...
        AtomValue(M metadata, A value, Func<A, bool> validator)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static Option<AtomValue<M, A>> New(M metadata, A value, Func<A, bool> validator)
        {
            var atom = new AtomValue<M, A>(metadata, value, validator ?? throw new ArgumentNullException(nameof(validator)));
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        internal static AtomValue<M, A> New(M metadata, A value) =>
            new AtomValue<M, A>(metadata, value, True);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator A(AtomValue<M, A> atom) =>
            atom.Value;
