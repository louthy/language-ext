...
namespace LanguageExt
{
    public static class HashMapExtensions
    {
        ...
        [Pure]
        public static R Find<A, B, C, D, T, R>(this HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> self, A aKey,
            B bKey, C cKey, D dKey, Func<T, R> Some, Func<R> None) =>
            self.Find(aKey,
                b => b.Find(bKey,
                    c => c.Find(cKey,
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> AddOrUpdate<A, B, C, D, T>(
            this HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> self, A aKey, B bKey, C cKey, D dKey, T value) =>
            self.AddOrUpdate(
                aKey,
                bKey,
                cKey,
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> AddOrUpdate<A, B, C, D, T>(
            this HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> self, A aKey, B bKey, C cKey, D dKey,
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, HashMap<D, V>>>> MapRemoveT<A, B, C, D, T, V>(
            this HashMap<A, HashMap<B, HashMap<C, HashMap<D, T>>>> self, Func<HashMap<D, T>, HashMap<D, V>> map)
        {
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, V>>> MapT<A, B, C, T, V>(
            this HashMap<A, HashMap<B, HashMap<C, T>>> self, Func<T, V> map)
        {
        ...
        [Pure]
        public static HashMap<A, HashMap<B, T>> FilterT<A, B, T>(this HashMap<A, HashMap<B, T>> self,
            Func<T, bool> pred)
        {
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, T>>> FilterT<A, B, C, T>(
            this HashMap<A, HashMap<B, HashMap<C, T>>> self, Func<T, bool> pred)
        {
        ...
        [Pure]
        public static HashMap<A, HashMap<B, T>> FilterRemoveT<A, B, T>(this HashMap<A, HashMap<B, T>> self,
            Func<T, bool> pred)
        {
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, T>>> FilterRemoveT<A, B, C, T>(
            this HashMap<A, HashMap<B, HashMap<C, T>>> self, Func<T, bool> pred)
        {
            return self.MapRemoveT(v => v.Filter(pred));
        }
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, V>>> SetItemT<A, B, C, V>(
            this HashMap<A, HashMap<B, HashMap<C, V>>> map, A aKey, B bKey, C cKey, V value)
        {
            var a = map.Find(aKey);
            if (a.IsNone) throw new ArgumentException("Key not found in Map");
            var av = a.Value;
        ...
        public static HashMap<A, HashMap<B, HashMap<C, HashMap<D, V>>>> SetItemT<A, B, C, D, V>(
            this HashMap<A, HashMap<B, HashMap<C, HashMap<D, V>>>> map, A aKey, B bKey, C cKey, D dKey, V value)
        {
            var a = map.Find(aKey);
            if (a.IsNone) throw new ArgumentException("Key not found in Map");
            var av = a.Value;
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, V>>> SetItemT<A, B, C, V>(
            this HashMap<A, HashMap<B, HashMap<C, V>>> map, A aKey, B bKey, C cKey, Func<V, V> Some)
        {
            var a = map.Find(aKey);
            if (a.IsNone) throw new ArgumentException("Key not found in Map");
            var av = a.Value;
        ...
        [Pure]
        public static HashMap<A, HashMap<B, HashMap<C, V>>> TrySetItemT<A, B, C, V>(
            this HashMap<A, HashMap<B, HashMap<C, V>>> map, A aKey, B bKey, C cKey, V value)
        {
            var a = map.Find(aKey);
            if (a.IsNone) return map;
        ...
        [Pure]
        public static S FoldT<A, B, C, S, V>(this HashMap<A, HashMap<B, HashMap<C, V>>> map, S state,
            Func<S, V, S> folder)
        {
