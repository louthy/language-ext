...
namespace LanguageExt
{
    ...
    public static partial class OptionAsyncExtensions
    {
        ...
        [Pure]
        public static OptionAsync<A> Subtract<NUM, A>(this OptionAsync<A> x, OptionAsync<A> y)
        ...
        [Pure]
        public static OptionAsync<A> Product<NUM, A>(this OptionAsync<A> x, OptionAsync<A> y)
            where NUM : struct, Num<A> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static OptionAsync<A> Divide<NUM, A>(this OptionAsync<A> x, OptionAsync<A> y)
            where NUM : struct, Num<A> =>
            from a in x
            from b in y
        ...
        [Pure]
        public static OptionAsync<C> Apply<A, B, C>(this OptionAsync<Func<A, B, C>> fabc, OptionAsync<A> fa,
            OptionAsync<B> fb) =>
            from x in fabc
        ...
        /// <returns>Applicative of type f(b -> c) derived from Applicative of Func<B, C></returns>
        [Pure]
        public static OptionAsync<Func<B, C>> Apply<A, B, C>(this OptionAsync<Func<A, Func<B, C>>> fabc,
            OptionAsync<A> fa) =>
