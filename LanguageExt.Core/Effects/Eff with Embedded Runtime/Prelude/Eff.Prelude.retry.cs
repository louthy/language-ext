...
public static partial class Prelude
{
    ...
    public static Eff<RT, A> retryWhile<RT, A>(
        Eff<RT, A> ma,
        Func<Error, bool> predicate) where RT : struct, HasIO<RT, Error> =>
        new(retryWhile(ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> retryWhile<RT, A>(
        ...
        where RT : struct, HasIO<RT, Error> =>
        new(retryWhile(schedule, ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> retryUntil<RT, A>(
        ...
        Func<Error, bool> predicate)
        where RT : struct, HasIO<RT, Error> =>
        new(retryUntil(ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> retryUntil<RT, A>(
        ...
        Func<Error, bool> predicate)
        where RT : struct, HasIO<RT, Error> =>
        new(retryUntil(schedule, ma.ToIO(), predicate));
}
