...
public static partial class Prelude
{
    ...
    public static Eff<RT, A> repeatWhile<RT, A>(
        ...
        new(repeatWhile(ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> repeatWhile<RT, A>(
        ...
        where RT : struct, HasIO<RT, Error> =>
        new(repeatWhile(schedule, ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> repeatUntil<RT, A>(
        ...
        Func<A, bool> predicate)
        where RT : struct, HasIO<RT, Error> =>
        new(repeatUntil(ma.ToIO(), predicate));
    ...
    public static Eff<RT, A> repeatUntil<RT, A>(
        ...
        Func<A, bool> predicate)
        where RT : struct, HasIO<RT, Error> =>
        new(repeatUntil(schedule, ma.ToIO(), predicate));
}
