...
namespace LanguageExt
{
    public static partial class EffExtensions
    {
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RetryWhile<RT, A>(this Eff<RT, A> ma, Func<A, bool> predicate) where RT : struct =>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RetryWhile<RT, A>(this Eff<RT, A> ma, Schedule schedule, Func<A, bool> predicate) where RT : struct =>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RetryUntil<RT, A>(this Eff<RT, A> ma, Func<A, bool> predicate) where RT : struct =>
        ...
        /// <typeparam name="A">Computation bound value type</typeparam>
        /// <returns>The result of the last invocation of ma</returns>
        public static Eff<RT, A> RetryUntil<RT, A>(this Eff<RT, A> ma, Schedule schedule, Func<A, bool> predicate) where RT : struct =>
