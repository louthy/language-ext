...
public static partial class Prelude
{
    ...
    /// </summary>
    internal static IOCatch<RT, E, A> matchErrorIO<RT, E, A>(Func<E, bool> predicate, Func<E, IO<RT, E, A>> Fail) 
        where RT : HasIO<RT, E> =>
        new (predicate, Fail);
    ...
    public static IOCatch<RT, E, A> @catch<RT, E, A>(E error, IO<RT, E, A> Fail) 
        where RT : HasIO<RT, E> =>
        matchErrorIO<RT, E, A>(e => EqDefault<E>.Equals(e, error), _ => Fail);
    ...
    public static IOCatch<RT, E, A> @catch<RT, E, A>(IO<RT, E, A> Fail)
        where RT : HasIO<RT, E> =>
        matchErrorIO<RT, E, A>(static _ => true, _ => Fail);
