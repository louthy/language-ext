...
public static partial class Prelude
{
    ...
    public static Aff<RT, A> AffMaybe<RT, A>(Func<RT, ValueTask<Fin<A>>> f) where RT : HasIO<RT, Error> =>
    ...
    /// <returns>Asynchronous IO monad that captures the effect</returns>
    [Pure, MethodImpl(Opt.Default)]
    public static Aff<RT, A> Aff<RT, A>(Func<RT, ValueTask<A>> f) where RT : HasIO<RT, Error> =>
    ...
    /// <returns>Asynchronous IO monad that captures the pure value</returns>
    [Pure, MethodImpl(Opt.Default)]
    public static Aff<RT, A> SuccessAff<RT, A>(A value) where RT : HasIO<RT, Error> =>
    ...
    /// <returns>Synchronous IO monad that captures the failure</returns>
    [Pure, MethodImpl(Opt.Default)]
    public static Aff<RT, A> FailAff<RT, A>(Error error) where RT : HasIO<RT, Error> =>
    ...
    public static Aff<OuterRT, A> localAff<OuterRT, InnerRT, A>(Func<OuterRT, InnerRT> f, Aff<InnerRT, A> ma)
        where OuterRT : HasIO<OuterRT, Error>
        where InnerRT : HasIO<InnerRT, Error> =>
    ...
    public static Eff<RT, Eff<Unit>> fork<RT, A>(Aff<RT, A> ma) where RT : HasIO<RT, Error> =>
        ma.Fork();
    ...
    /// <returns>Returns an `Eff Unit` as its bound value.  If it runs, it will cancel the
    /// forked child expression</returns>
    public static Eff<RT, ForkEff<RT, A>> fork<RT, A>(Effect<RT, A> ma) where RT : HasIO<RT, Error> =>
        ma.RunEffect().ToEff().Fork();
    ...
    public static Aff<RT, A> localCancel<RT, A>(Aff<RT, A> ma) where RT : HasIO<RT, Error> =>
    ...
    /// TODO: Migrate this to yield a Transducer
    /// <summary>
    /// Cancel the asynchronous operation
    /// </summary>
    /// <typeparam name="RT">Runtime</typeparam>
    /// <returns>Unit</returns>
    public static Aff<RT, Unit> cancel<RT>() where RT : HasIO<RT, Error> =>
        AffMaybe(static (RT env) =>
                 {
    ...
    public static Eff<RT, CancellationTokenSource> cancelTokenSource<RT>()
        where RT : HasIO<RT, Error> =>
        lift(static (RT env) => env.CancellationTokenSource);
    ...
    [Pure, MethodImpl(Opt.Default)]
    public static Aff<RT, A> timeout<RT, A>(TimeSpan timeoutDelay, Aff<RT, A> ma) where RT : HasIO<RT, Error> =>
    ...
    public static Eff<RT, R> eff<RT, A, B, C, D, E, R>(
        ...
        Eff<RT, D> md,
        Eff<RT, E> me,
        Eff<RT, R> mr) where RT : HasIO<RT, Error> =>
        from a in ma
        from b in mb
        from c in mc
        from d in md
