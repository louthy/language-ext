...
namespace LanguageExt.Pipes
{
    public abstract class Release<A>
    {
        ...
        public abstract Consumer<RT, IN, B> SelectMany<RT, IN, B>(Func<A, Consumer<RT, IN, B>> f) where RT : HasIO<RT, Error>;
        public abstract ConsumerLift<RT, IN, B> SelectMany<RT, IN, B>(Func<A, ConsumerLift<RT, IN, B>> f) where RT : HasIO<RT, Error>;
        public abstract Producer<OUT, B> SelectMany<OUT, B>(Func<A, Producer<OUT, B>> f);
        public abstract Producer<RT, OUT, B> SelectMany<RT, OUT, B>(Func<A, Producer<RT, OUT, B>> f) where RT : HasIO<RT, Error>;
        public abstract Pipe<IN, OUT, B> SelectMany<IN, OUT, B>(Func<A, Pipe<IN, OUT, B>> f);
        public abstract Pipe<RT, IN, OUT, B> SelectMany<RT, IN, OUT, B>(Func<A, Pipe<RT, IN, OUT, B>> f) where RT : HasIO<RT, Error>;
        ...
        public abstract ConsumerLift<RT, IN, A> ToConsumerLift<RT, IN>() where RT : HasIO<RT, Error>;

        public abstract Consumer<RT, IN, A> InterpretConsumer<RT, IN>() where RT : HasIO<RT, Error>;
        public abstract Producer<RT, OUT, A> InterpretProducer<RT, OUT>() where RT : HasIO<RT, Error>;
        public abstract Pipe<RT, IN, OUT, A> InterpretPipe<RT, IN, OUT>() where RT : HasIO<RT, Error>;
        public abstract Client<RT, REQ, RES, A> InterpretClient<RT, REQ, RES>() where RT : HasIO<RT, Error>;
        public abstract Server<RT, REQ, RES, A> InterpretServer<RT, REQ, RES>() where RT : HasIO<RT, Error>;
        ...
        public Consumer<RT, IN, B> Bind<RT, IN, B>(Func<A, Consumer<RT, IN, B>> f) where RT : HasIO<RT, Error> =>
            SelectMany(f);
        
        public Producer<OUT, B> Bind<OUT, B>(Func<A, Producer<OUT, B>> f) =>
            SelectMany(f);
        
        public Producer<RT, OUT, B> Bind<RT, OUT, B>(Func<A, Producer<RT, OUT, B>> f) where RT : HasIO<RT, Error> =>
            SelectMany(f);
        
        public Pipe<IN, OUT, B> Bind<IN, OUT, B>(Func<A, Pipe<IN, OUT, B>> f) =>
            SelectMany(f);
        
        public Pipe<RT, IN, OUT, B> Bind<RT, IN, OUT, B>(Func<A, Pipe<RT, IN, OUT, B>> f) where RT : HasIO<RT, Error> =>
            SelectMany(f);
        ...
        public Consumer<RT, IN, C> SelectMany<RT, IN, B, C>(Func<A, Consumer<RT, IN, B>> f, Func<A, B, C> project) where RT : HasIO<RT, Error> =>
            SelectMany(a => f(a).Select(b => project(a, b)));    
        
        public Producer<OUT, C> SelectMany<OUT, B, C>(Func<A, Producer<OUT, B>> f, Func<A, B, C> project) =>
            SelectMany(a => f(a).Select(b => project(a, b)));    
        
        public Producer<RT, OUT, C> SelectMany<RT, OUT, B, C>(Func<A, Producer<RT, OUT, B>> f, Func<A, B, C> project) where RT : HasIO<RT, Error> =>
            SelectMany(a => f(a).Select(b => project(a, b)));    
        
        public Pipe<IN, OUT, C> SelectMany<IN, OUT, B, C>(Func<A, Pipe<IN, OUT, B>> f, Func<A, B, C> project) =>
            SelectMany(a => f(a).Select(b => project(a, b)));    
        
        public Pipe<RT, IN, OUT, C> SelectMany<RT, IN, OUT, B, C>(Func<A, Pipe<RT, IN, OUT, B>> f, Func<A, B, C> project) where RT : HasIO<RT, Error> =>
            SelectMany(a => f(a).Select(b => project(a, b)));
