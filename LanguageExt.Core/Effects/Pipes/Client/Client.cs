...
namespace LanguageExt.Pipes
{
    ...
    public class Client
    {
        ...
        public static Client<RT, REQ, RES, R> Pure<RT, REQ, RES, R>(R value) where RT : struct, HasIO<RT, Error> =>
        ...
        /// </remarks>
        [Pure, MethodImpl(Proxy.mops)]
        public static Client<RT, REQ, RES, RES> request<RT, REQ, RES>(REQ value) where RT : struct, HasIO<RT, Error> =>
        ...
        /// </summary>
        [Pure, MethodImpl(Proxy.mops)]
        public static Client<RT, REQ, RES, R> lift<RT, REQ, RES, R>(Eff<R> ma) where RT : struct, HasIO<RT, Error> =>
        ...
        /// </summary>
        [Pure, MethodImpl(Proxy.mops)]
        public static Client<RT, REQ, RES, R> lift<RT, REQ, RES, R>(Eff<RT, R> ma) where RT : struct, HasIO<RT, Error> =>
