...
namespace LanguageExt
{
    public static class ValueTaskExtensions
    {
        ...
        /// </summary>
        internal static async ValueTask<IList<B>> WindowMap<A, B>(this IEnumerable<ValueTask<A>> ma, Func<A, B> f, CancellationToken token) =>
            await ma.WindowMap(SysInfo.DefaultAsyncSequenceParallelism, f, token);
        ...
        internal static async ValueTask<IList<B>> WindowMap<A, B>(
            ...
            await ma.Map(x => x.AsTask()).WindowMap(SysInfo.DefaultAsyncSequenceParallelism, f, token);
    }
}
