...
/// <summary>
/// Extension methods for `ValueTask`
/// </summary>
public static partial class ValueTaskExtensions
{
    ...
    public static ValueTask<B> Action<A, B>(this ValueTask<A> fa, ValueTask<B> fb) =>
        default(ApplValueTask<A, B>).Action(fa, fb);
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<B> Apply<A, B>(this ValueTask<Func<A, B>> ff, ValueTask<A> fx) =>
        default(ApplValueTask<A, B>).Apply(ff, fx);
    ...
    /// <typeparam name="B">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<B> Apply<A, B>(this Func<A, B> ff, ValueTask<A> fx) =>
        default(ApplValueTask<A, B>).Apply(ff.AsValueTask(), fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, C>> Apply<A, B, C>(this ValueTask<Func<A, B, C>> ff, ValueTask<A> fx) =>
    ...
    /// <typeparam name="C">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, C>> Apply<A, B, C>(this Func<A, B, C> ff, ValueTask<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, D>>> Apply<A, B, C, D>(this ValueTask<Func<A, B, C, D>> ff, ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <typeparam name="D">Output bound value type</typeparam>
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, D>>> Apply<A, B, C, D>(this Func<A, B, C, D> ff, ValueTask<A> fx) =>
        curry(ff).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, Func<D, E>>>> Apply<A, B, C, D, E>(
        this ValueTask<Func<A, B, C, D, E>> ff, 
        ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, Func<D, Func<E, F>>>>> Apply<A, B, C, D, E, F>(
        this ValueTask<Func<A, B, C, D, E, F>> ff, 
        ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, Func<D, Func<E, Func<F, G>>>>>> Apply<A, B, C, D, E, F, G>(
        this ValueTask<Func<A, B, C, D, E, F, G>> ff, 
        ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, H>>>>>>> Apply<A, B, C, D, E, F, G, H>(
        this ValueTask<Func<A, B, C, D, E, F, G, H>> ff, 
        ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
    ...
    /// <returns>Bound result of the application of the function to the argument</returns>
    public static ValueTask<Func<B, Func<C, Func<D, Func<E, Func<F, Func<G, Func<H, I>>>>>>>> Apply<A, B, C, D, E, F, G, H, I>(
        this ValueTask<Func<A, B, C, D, E, F, G, H, I>> ff, 
        ValueTask<A> fx) =>
        ff.Map(curry).Apply(fx);
