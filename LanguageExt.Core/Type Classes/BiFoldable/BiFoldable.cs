...
[Trait("BiFold*")]
public interface BiFoldable<in F, out A, out B> : Trait
{
    /// <summary>
    ...
    [Pure]
    public static abstract S BiFold<S>(F foldable, S state, Func<S, A, S> fa, Func<S, B, S> fb);
    ...
    /// <returns>The aggregate state</returns>
    [Pure]
    public static abstract S BiFoldBack<S>(F foldable, S state, Func<S, A, S> fa, Func<S, B, S> fb);
}
...
public interface BiFoldable<F, A> : Foldable<F, A>
{
    ...
    /// <returns>The aggregate state</returns>
    [Pure]
    public static abstract S BiFold<S>(F foldable, S state, Func<S, A, S> fa, Func<S, S> fb);
    ...
    /// <returns>The aggregate state</returns>
    [Pure]
    public static abstract S BiFoldBack<S>(F foldable, S state, Func<S, A, S> fa, Func<S, S> fb);
}
