...
/// </summary>
[Trait("M*")]
public interface MonadRWS<MonoidW, R, W, S, A> : Trait
    where MonoidW : Monoid<W>
{
    ...
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, R> Ask();
    ...
    /// <returns></returns>
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, A> Local(RWS<MonoidW, R, W, S, A> ma, Func<R, R> f);
    ...
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, Unit> Tell(W what);
    ...
    /// </summary>
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, (A, B)> Listen<B>(RWS<MonoidW, R, W, S, A> ma, Func<W, B> f);
    ...
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, S> Get();
    ...
    [Pure]
    public static abstract RWS<MonoidW, R, W, S, Unit> Put(S state);
}
