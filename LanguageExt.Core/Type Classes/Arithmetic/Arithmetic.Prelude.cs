...
namespace LanguageExt
{
    public static partial class TypeClass
    {
        ...
        [Pure]
        public static A plus<ARITH, A>(A x, A y) where ARITH : struct, Arithmetic<A> =>
            default(ARITH).Plus(x, y);
        ...
        [Pure]
        public static A subtract<ARITH, A>(A x, A y) where ARITH : struct, Arithmetic<A> =>
            default(ARITH).Subtract(x, y);
        ...
        [Pure]
        public static A product<ARITH, A>(A x, A y) where ARITH : struct, Arithmetic<A> =>
            default(ARITH).Product(x, y);
        ...
        [Pure]
        public static A negate<ARITH, A>(A x) where ARITH : struct, Arithmetic<A> =>
            default(ARITH).Negate(x);
    }
}
