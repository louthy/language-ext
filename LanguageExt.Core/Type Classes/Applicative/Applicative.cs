...
[Trait("Appl*")]
public interface ApplicativePure<FA, A> : Trait
{
    /// <summary>
    /// Applicative return
    /// </summary>
    ...
    [Pure]
    public static abstract FA Pure(A x);
}
...
public interface Applicative<FAB, FA, FB, A, B> : ApplicativePure<FA, A>
{
    ...
    [Pure]
    public static abstract FB Apply(FAB fab, FA fa);
    ...
    /// <returns>Applicative of type FB derived from Applicative of B</returns>
    [Pure]
    public static abstract FB Action(FA fa, FB fb);
}
...
/// <typeparam name="B">Type of the bound return value</typeparam>
[Trait("Appl*")]
public interface Applicative<in FABC, out FBC, FA, in FB, out FC, A, B> : ApplicativePure<FA, A>
{
    /// <summary>
    /// Apply
    /// </summary>
    ...
    [Pure]
    public static abstract FBC? Apply(FABC fabc, FA fa);
    ...
    [Pure]
    public static abstract FC Apply(FABC fabc, FA fa, FB fb);
}
