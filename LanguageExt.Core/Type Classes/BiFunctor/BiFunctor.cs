...
/// </summary>
[Trait("BiF*")]
public interface BiFunctor<in FAB, out FR, out A, out B, in R> : Trait
{
    /// <summary>
    ...
    [Pure]
    public static abstract FR BiMap(FAB ma, Func<A, R> fa, Func<B, R> fb);
}
...
/// </summary>
[Trait("BiF*")]
public interface BiFunctor<in FAB, out FUV, out A, out B, in U, in V> : Trait
{
    /// <summary>
    ...
    /// <returns>Mapped functor</returns>
    [Pure]
    public static abstract FUV BiMap(FAB ma, Func<A, U> fa, Func<B, V> fb);
}
