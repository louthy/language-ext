    ...
    Functor<ValueTuple<A, B>, ValueTuple<A, R>, B, R>
{
    ...
    [Pure]
    public static ValueTuple<A, R> Map(ValueTuple<A, B> ma, Func<B, R> f) =>
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static Tuple<A, R> Map(Tuple<A, B> ma, Func<B, R> f) =>
    ...
    Functor<ValueTuple<A, B, C>, ValueTuple<A, R, C>, B, R>
{
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static ValueTuple<A, R, C> Map(ValueTuple<A, B, C> ma, Func<B, R> f) =>
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static Tuple<A, R, C> Map(Tuple<A, B, C> ma, Func<B, R> f) =>
