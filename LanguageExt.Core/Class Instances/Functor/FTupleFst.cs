    ...
    Functor<ValueTuple<A, B>, ValueTuple<R, B>, A, R>
{
    ...
    [Pure]
    public static Tuple<R, B> Map(Tuple<A, B> ma, Func<A, R> f) =>
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static ValueTuple<R, B> Map(ValueTuple<A, B> ma, Func<A, R> f) =>
    ...
    Functor<ValueTuple<A, B, C>, ValueTuple<R, B, C>, A, R>
{
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static Tuple<R, B, C> Map(Tuple<A, B, C> ma, Func<A, R> f) =>
    ...
    /// <returns>Target tuple</returns>
    [Pure]
    public static ValueTuple<R, B, C> Map(ValueTuple<A, B, C> ma, Func<A, R> f) =>
