...
public static partial class Prelude
{
    ...
    private delegate bool TryParse<T>(string value, [NotNullWhen(true)] out T? result);

    private delegate bool TryParseIgnoreCase<T>(string value, bool ignoreCase, [NotNullWhen(true)] out T? result);
