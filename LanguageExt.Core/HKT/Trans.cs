...
namespace LanguageExt
{
    ...
    /// 
    /// </summary>
    public struct Trans<OuterEnv, OuterOut, OuterMonad, OuterType, InnerEnv, InnerOut, InnerMonad, InnerType, A> : 
            ...
            where InnerMonad : struct, Monad<InnerEnv, InnerOut, InnerType, A>
    {
        ...
        public static readonly Trans<OuterEnv, OuterOut, OuterMonad, OuterType, InnerEnv, InnerOut, InnerMonad, InnerType, A> Inst;
        ...
        public NewOuterType Bind<
            ...
            MO_I_NewInnerMonad, O_I_NewInnerType, MI_NewInnerMonad, B_NewInnerType
        >(OuterType ma, Func<A, NewOuterType> f)
            ...
            where MO_I_NewInnerMonad : struct, Monad<OuterEnv, OuterOut, O_I_NewInnerType, B_NewInnerType>
            where MI_NewInnerMonad : struct, Monad<InnerEnv, InnerOut, B_NewInnerType, NewInnerType> =>
                Trans<OuterEnv, OuterOut, MO_I_NewInnerMonad, O_I_NewInnerType, InnerEnv, InnerOut, MI_NewInnerMonad, B_NewInnerType, NewInnerType>.Inst
                    .Bind<NewOuterMonad, NewOuterType, NewInnerMonad, NewInnerType, B>(
                        Trans<InnerEnv, InnerOut, MI_NewOuterMonad, I_NewOuterType, OuterEnv, OuterOut, NewOuterMonad, NewOuterType, NewInnerType>.Inst
                            .Sequence<MO_I_NewInnerMonad, O_I_NewInnerType, MI_NewInnerMonad, B_NewInnerType>(
                                Trans<InnerEnv, InnerOut, MI_O_NewOuterMonad, I_O_NewOuterType, OuterEnv, OuterOut, MO_NewOuterMonad, O_NewOuterType, NewOuterType>.Inst
        ...
        public NewOuterType Traverse<NewOuterMonad, NewOuterType, NewInnerMonad, NewInnerType, B>(OuterType ma, Func<A, B> f)
            ...
            where NewInnerMonad : struct, Monad<OuterEnv, OuterOut, NewInnerType, B> =>
                MOuter.Fold(ma, default(NewOuterMonad).Return(_ => default(NewInnerMonad).Zero()), (outerState, innerA) =>
                    Trans<InnerEnv, InnerOut, NewOuterMonad, NewOuterType, OuterEnv, OuterOut, NewInnerMonad, NewInnerType, B>.Inst.Plus(outerState,
        ...
        public OuterType Zero() =>
            MOuter.Return(_ => MInner.Zero());
    }

    public struct Trans<OuterEnv, OuterOut, OuterMonad, OuterType, InnerEnv, InnerOut, InnerMonad, InnerType, NumA, A>
        where OuterMonad : struct, Monad<OuterEnv, OuterOut, OuterType, InnerType>
        where InnerMonad : struct, Monad<InnerEnv, InnerOut, InnerType, A>
        where NumA : struct, Num<A>
    {
        public static readonly Trans<OuterEnv, OuterOut, OuterMonad, OuterType, InnerEnv, InnerOut, InnerMonad, InnerType, NumA, A> Inst;
