...
namespace LanguageExt
{
    public partial class TaskT
    {
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<EitherUnsafe<L, A>> Sequence<L, A>(this EitherUnsafe<L, Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<OptionUnsafe<A>> Sequence<A>(this OptionUnsafe<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<Try<A>> Sequence<A>(this Try<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<TryOption<A>> Sequence<A>(this TryOption<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<TryAsync<A>> Sequence<A>(this TryAsync<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        public static Task<OptionAsync<A>> Sequence<A>(this OptionAsync<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<TryOptionAsync<A>> Sequence<A>(this TryOptionAsync<Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        [Obsolete(Change.UseEffMonadInstead)]
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<EitherAsync<L, A>> Sequence<L, A>(this EitherAsync<L, Task<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Task<Aff<A>> Sequence<A>(this Aff<Task<A>> ta) =>
            ta.Traverse(identity);
