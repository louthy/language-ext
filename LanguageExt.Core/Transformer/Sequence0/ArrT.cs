...
namespace LanguageExt
{
    public partial class ArrT
    {
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Arr<EitherUnsafe<L, A>> Sequence<L, A>(this EitherUnsafe<L, Arr<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Arr<OptionUnsafe<A>> Sequence<A>(this OptionUnsafe<Arr<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Arr<Try<A>> Sequence<A>(this Try<Arr<A>> ta) =>
            ta.Traverse(identity);
        ...
        /// <returns>Mapped monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Arr<TryOption<A>> Sequence<A>(this TryOption<Arr<A>> ta) =>
            ta.Traverse(identity);
