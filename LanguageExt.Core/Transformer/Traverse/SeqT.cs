...
namespace LanguageExt
{
    public static partial class SeqT
    {
        ...
        public static Seq<Validation<Fail, B>> Traverse<Fail, A, B>(this Validation<Fail, Seq<A>> ma, Func<A, B> f) =>
            ma.Match(
                Fail: ex => Seq(Validation<Fail, B>.Fail(ex)),
