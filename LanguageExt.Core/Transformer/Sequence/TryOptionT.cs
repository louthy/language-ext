...
namespace LanguageExt
{
    public partial class TryOptionT
    {
        ...
        /// <returns>Mapped and lifted monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TryOption<Fin<B>> Sequence<A, B>(this Fin<A> ta, Func<A, TryOption<B>> f) =>
            ta.Map(f).Sequence();
        ...
        /// <returns>Mapped and lifted monad</returns>
        [Pure, MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static TryOption<Eff<B>> Sequence<A, B>(this Eff<A> ta, Func<A, TryOption<B>> f) =>
            ta.Map(f).Traverse(Prelude.identity);
    }
}
