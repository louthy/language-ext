...
namespace LanguageExt.ClassInstances
{
    ...
    public struct FSet<A, B, C> :
        Applicative<Set<Func<A, Func<B, C>>>, Set<Func<B, C>>, Set<A>, Set<B>, Set<C>, A, B, C>
    {
        public static readonly FSet<A, B, C> Inst = default(FSet<A, B, C>);
    ...
    public struct FSet<OrdFAB, OrdA, OrdB, A, B> :
    ...
    {
        public static readonly FSet<OrdFAB, OrdA, OrdB, A, B> Inst = default(FSet<OrdFAB, OrdA, OrdB, A, B>);
    ...
    public struct FSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C> :
    ...
    {
        public static readonly FSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C> Inst = default(FSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C>);
    ...
    public struct FSet<OrdFAAA, OrdFAA, OrdA, A> :
