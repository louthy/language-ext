...
namespace LanguageExt.ClassInstances
{
    ...
    public struct FTryOptionAsync<A, B, C> :
    ...
    {
        public static readonly FTryOptionAsync<A, B, C> Inst = default(FTryOptionAsync<A, B, C>);
    ...
    public struct FTryOptionAsync<A> :
    ...
    {
        public static readonly FTryOptionAsync<A> Inst = default(FTryOptionAsync<A>);
