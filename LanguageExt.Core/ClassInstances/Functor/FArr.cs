...
namespace LanguageExt.ClassInstances
{
    ...
    public struct FArr<A, B, C> :
        Applicative<Arr<Func<A, Func<B, C>>>, Arr<Func<B, C>>, Arr<A>, Arr<B>, Arr<C>, A, B, C>
    {
        public static readonly FArr<A, B, C> Inst = default(FArr<A, B, C>);
