...
namespace LanguageExt.ClassInstances
{
    ...
    public struct FHashSet<A, B, C> :
        Applicative<HashSet<Func<A, Func<B, C>>>, HashSet<Func<B, C>>, HashSet<A>, HashSet<B>, HashSet<C>, A, B, C>
    {
        public static readonly FHashSet<A, B, C> Inst = default(FHashSet<A, B, C>);
    ...
    {
        public static readonly FHashSet<A> Inst = default(FHashSet<A>);
    ...
    public struct FHashSet<OrdFAB, OrdA, OrdB, A, B> :
    ...
    {
        public static readonly FHashSet<OrdFAB, OrdA, OrdB, A, B> Inst = default(FHashSet<OrdFAB, OrdA, OrdB, A, B>);
    ...
    public struct FHashSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C> :
    ...
    {
        public static readonly FHashSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C> Inst = default(FHashSet<OrdFABC, OrdFBC, OrdA, OrdB, OrdC, A, B, C>);
    ...
    public struct FHashSet<OrdFAAA, OrdFAA, OrdA, A> :
