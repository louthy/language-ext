...
namespace LanguageExt
{
    public static partial class Prelude
    {
        ...
        /// Tri-map to tuple
        /// </summary>
        public static Tuple<R1, R2, R3> map<T1, T2, T3, R1, R2, R3>(Tuple<T1, T2, T3> self, Func<T1, R1> firstMap, Func<T2, R2> secondMap, Func<T3, R3> thirdMap) =>
        ...
        /// Tri-fold
        /// </summary>
        public static S fold<T1, T2, T3, S>(Tuple<T1, T2, T3> self, S state, Func<S, T1, S> firstFold, Func<S, T2, S> secondFold, Func<S, T3, S> thirdFold) =>
            thirdFold(secondFold(firstFold(state, self.Item1), self.Item2), self.Item3);

        /// <summary>
        /// Tri-fold
        /// </summary>
        public static S foldBack<T1, T2, T3, S>(Tuple<T1, T2, T3> self, S state, Func<S, T3, S> firstFold, Func<S, T2, S> secondFold, Func<S, T1, S> thirdFold) =>
