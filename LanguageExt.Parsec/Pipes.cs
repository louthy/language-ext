...
namespace LanguageExt
{
    public static class ParsecPipes
    {
        ...
        /// </summary>
        public static Pipe<RT, PString, OUT, Unit> ToPipe<RT, OUT>(this Parser<OUT> ma) where RT : HasIO<RT> =>
        ...
        /// If the parser fails then the pipe fails
        /// </summary>
        public static Pipe<RT, PString<IN>, OUT, Unit> ToPipe<RT, IN, OUT>(this Parser<IN, OUT> ma) where RT : HasIO<RT> =>
