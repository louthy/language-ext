...
`Core` | UnCurrying | [Translate a curried function (sequence of functions, each with a single argument) into a function that takes multiple arguments](https://louthy.github.io/languageext.core/LanguageExt/Prelude_.htm#unCurry<T1, T2, TResult>)
