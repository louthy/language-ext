...
namespace LanguageExt.Tests
{
    public class TraverseTests
    {
        ...
        public static async void TraverseAsync()
        {
            ...
            var fs = Range(1, SysInfo.DefaultAsyncSequenceConcurrency).Map(x => Task.Run(() =>
            {
                Thread.Sleep(3000);
                return x;
            }));
            ...
            Assert.True(Set.createRange(res) == toSet(Range(2, SysInfo.DefaultAsyncSequenceConcurrency, 2)));
