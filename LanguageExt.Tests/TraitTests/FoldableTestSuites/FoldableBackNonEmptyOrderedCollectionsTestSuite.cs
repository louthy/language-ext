...
public class FoldableBackNonEmptyOrderedCollectionsTestSuite<F>
    where F : FoldableBack<F>
{
    ...
    FoldableBackNonEmptyOrderedCollectionsTestSuite(Func<IEnumerable<int>, K<F, int>> construct)
    {
    ...
    {
        var suite = new FoldableBackNonEmptyOrderedCollectionsTestSuite<F>(construct);
        suite.FoldBackTest();
