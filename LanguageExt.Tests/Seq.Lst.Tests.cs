...
namespace LanguageExt.Tests
{
    public class SeqLstTests
    {
        ...
        {
            var seq1 = Seq(List.create(10, 100));
            var seq2 = Seq(List.create(1, 2, 3, 4, 5));
        ...
        {
            var seq = Seq(List.create(1, 2, 3, 4, 5));
        ...
        {
            var seq = Seq(List.create("a", "b", "c", "d", "e"));
        ...
        {
            var seq1 = Seq(List.create('a', 'b', 'c', 'd', 'e'));
            var seq2 = Seq(List.create('a', 'b', 'c', '_', 'e'));
