        ...
        Has<Eff<RT>, ConsoleIO>
{
    ...
    /// </summary>
    public static Producer<ConsoleKeyInfo, Eff<RT>, Unit> readKeys =>
    ...
    /// </summary>
    public static Producer<int, Eff<RT>, Unit> reads =>
    ...
    /// </summary>
    public static Producer<string, Eff<RT>, Unit> readLines =>
