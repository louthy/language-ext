...
| `Core`   | `IterableK<T>` and `IterableBackK`     | [Access a forward `Iterator` or a reverse `Iterator`](https://louthy.github.io/language-ext/LanguageExt.Core/Traits/IterableK/index.html)                              |
| `Core`   | `Foldable<T>` and `FoldableBackK`      | [Aggregation over a structure](https://louthy.github.io/language-ext/LanguageExt.Core/Traits/Foldable/index.html)                                                      |
